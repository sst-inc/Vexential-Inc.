    ...
    <StyledView className="flex-1 flex-row">
      ...
      <StyledView className="flex-1 flex-col bg-blue-100 p-0">
        ...
        <StyledView className="flex-row justify-center items-center p-4">
          <StyledText className="text-black text-xl font-semibold">Profile</StyledText>
        </StyledView>
          ...
          <StyledView className="flex flex-col items-start">
            ...
            <StyledView className="flex-row items-center mb-4">
              <StyledView className="w-[300px] h-[64px] bg-[#B5E3F2] flex justify-center items-center">
                <StyledText className="text-white text-base font-semibold">LANGUAGE</StyledText>
              </StyledView>
            ...
            <StyledView className="flex-row items-center mb-4">
              <StyledView className="w-[300px] h-[64px] bg-[#B5E3F2] flex justify-center items-center">
                <StyledText className="text-white text-base font-semibold">AGE</StyledText>
              </StyledView>
              <StyledView className="w-[554px] h-[64px] bg-white flex justify-center items-center ml-0">
                <StyledText className="text-black text-base font-semibold">60 to 70</StyledText>
              </StyledView>
            ...
            <StyledView className="flex-row items-center">
              ...
              <StyledView className="w-[554px] h-[64px] bg-white flex justify-center items-center ml-0">
                <StyledText className="text-black text-base font-semibold">Vegetarian</StyledText>
              </StyledView>
              <StyledPressable className="w-[118px] h-[64px] ml-2 rounded-md bg-[#CEE5EC] flex justify-center items-center">
                <StyledText className="text-black text-base font-semibold">Change</StyledText>
              </StyledPressable>
